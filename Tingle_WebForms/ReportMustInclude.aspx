        ...
        <ContentTemplate>
            <div class="divcenter">
                ...
                <asp:Panel ID="pnlFilter" runat="server">
                    <table>
                        ...
                        <tr runat="server" id="tr3" visible="false">
                            ...
                            <td class="tdleft">
                                <telerik:RadDropDownList ID="ddlWarehouse" runat="server" SelectMethod="GetWarehouses" Skin="Default" Width="125px" AutoPostBack="true"
                                    CausesValidation="false" DataTextField="WarehouseText" DataValueField="RecordId" DefaultMessage="Any Warehouse">
                                </telerik:RadDropDownList>
                            </td>
                        </tr>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="PO" SortExpression="PO">
                                            <ItemTemplate>
                                                ...
                                                <telerik:RadToolTip runat="server" ID="ttPO" Position="TopRight" RelativeTo="Element" TargetControlID="lblPO" ShowEvent="OnMouseOver"
                                        ...
                                        <asp:TemplateField HeaderText="Pattern" SortExpression="Pattern">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPattern" runat="server" Text='<%#: Item.Pattern %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" />
                                        </asp:TemplateField>
                ...
                <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                    ...
                    <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.MustIncludeForm" SelectMethod="GetFormDetails" OnPreRender="fvReport_PreRender"
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:PlaceHolder runat="server" ID="phFVDetails">
                                ...
                                <asp:Label ID="lblRecordId" runat="server" Text='<%#: Eval("RecordId") %>'></asp:Label></td>
                                    ...
                                    <tr>
                                        <td class="tdright">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Customer field is required."
                                        ...
                                        <td class="tdright">Warehouse:</td>
                                        <td class="tdleft">
                                            <telerik:RadDropDownList ID="ddlWarehouseEdit" runat="server" SelectMethod="GetWarehouses" Skin="Default" Width="175px" AutoPostBack="true"
                                                CausesValidation="false" DataTextField="WarehouseText" DataValueField="RecordId" OnDataBound="ddlWarehouseEdit_DataBound">
                                            </telerik:RadDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
