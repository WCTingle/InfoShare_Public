        ...
        <ContentTemplate>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="tdleft">
                        <telerik:RadDropDownList ID="ddlWarehouse" runat="server" SelectMethod="GetWarehouses" Skin="Default" Width="75px" AutoPostBack="true" 
                            CausesValidation="false" DataTextField="WarehouseText" DataValueField="RecordId"></telerik:RadDropDownList></td>
                </tr>
                <tr>
