            ...
            <div class="divcenter">
                ...
                <asp:Panel ID="pnlFilter" runat="server">
                    <table>
                        ...
                        <tr runat="server" id="tr1" visible="false">
                            ...
                            <td class="tdleft">
                                <asp:TextBox ID="txtAccountNumber" runat="server" AutoPostBack="true" MaxLength="6"></asp:TextBox>
                            </td>
                            <td class="tdright">Product:</td>
                            <td class="tdleft">
                                <telerik:RadDropDownList runat="server" ID="ddlProduct" AutoPostBack="true" CausesValidation="false" Width="100px" Skin="Default"
                                    DefaultMessage="Any Product" SelectMethod="GetProducts" DataTextField="ProductText" DataValueField="RecordId">
                                </telerik:RadDropDownList>
                            </td>
                                ...
                                <asp:GridView ID="gvReport" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Product">
                                            <ItemTemplate>
                                                <asp:Label ID="lblProduct" runat="server" Text='<%#: Item.Product.ProductText %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" />
                                        </asp:TemplateField>
                ...
                <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                    ...
                    <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.PriceChangeRequestForm" SelectMethod="GetFormDetails"
                        ...
                        OnItemUpdating="fvReport_ItemUpdating" OnPreRender="fvReport_PreRender">
                        <EditItemTemplate>
                            <asp:PlaceHolder runat="server" ID="phFVDetails">
                                ...
                                <table>
                                    <tr class="trheader">
                                        <td colspan="4" class="tdheader">Price Change Request Details</td>
                                    </tr>
                                    <tr>
                                ...
                                <asp:Label ID="lblRecordId" runat="server" Text='<%#: Eval("RecordId") %>'></asp:Label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdright">Product:</td>
                                        <td class="tdleft">
                                            <telerik:RadDropDownList runat="server" ID="ddlProductEdit" AutoPostBack="true" CausesValidation="false"
                                                Width="100px" Skin="Default" OnDataBinding="ddlProductEdit_DataBinding">
                                                <Items>
                                                    <telerik:DropDownListItem Text="Armstrong" Value="Armstrong" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdright">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="SKU field is required."
                                                ControlToValidate="txtSKUEdit" ForeColor="Red" Display="None"></asp:RequiredFieldValidator>Material SKU:</td>
                                        <td class="tdleft">
                                    ...
                                    <tr>
                                        <td class="tdright">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Order # field is required."
                                                ControlToValidate="txtOrderNumberEdit" ForeColor="Red" Display="None"></asp:RequiredFieldValidator>Reference / Order #:</td>
                                        <td class="tdleft">
                                    ...
                                    <tr>
                                        <td class="tdright">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Cross Reference Old Order # field is required."
                                        ...
                                        <td class="tdright">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Price field is required."
