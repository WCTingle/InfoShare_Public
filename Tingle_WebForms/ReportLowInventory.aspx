        ...
        <ContentTemplate>
            <div class="divcenter">
                                ...
                                <asp:GridView ID="gvReport" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Plant">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPlant" runat="server" Text='<%#: Item.Plant.PlantText %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="15%" />
                                        </asp:TemplateField>
                ...
                <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                    ...
                    <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.LowInventoryForm" SelectMethod="GetFormDetails" OnDataBinding="fvReport_DataBinding"
                        ...
                        <EditItemTemplate>
                            <asp:PlaceHolder runat="server" ID="phFVDetails">
                                ...
                                <table>
                                    <tr class="trheader">
                                        <td colspan="4" class="tdheader">Low Inventory Request Details</td>
                                    </tr>
                                    <tr>
