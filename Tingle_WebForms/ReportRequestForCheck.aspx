        ...
        <ContentTemplate>
            <div class="divcenter">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Payable To" SortExpression="PayableTo">
                                            <ItemTemplate>
                                                ...
                                                <telerik:RadToolTip runat="server" ID="ttPayableTo" Position="TopRight" RelativeTo="Element" TargetControlID="lblPayableTo" ShowEvent="OnMouseOver"
                ...
                <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                    ...
                    <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.RequestForCheckForm" SelectMethod="GetFormDetails" OnDataBinding="fvReport_DataBinding"
                        ...
                        <EditItemTemplate>
                            <asp:PlaceHolder runat="server" ID="phFVDetails">
                                ...
                                <table>
                                    <tr class="trheader">
                                        <td colspan="4" class="tdheader">Request For Check Request Details</td>
                                    </tr>
                                    <tr>
                                ...
                                <asp:Label ID="lblRecordId" runat="server" Text='<%#: Eval("RecordId") %>'></asp:Label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdright">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Approved By field is required."
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdright">Phone:</td>
                                        <td class="tdleft">
                                            <asp:TextBox ID="txtShipToPhoneEdit" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
