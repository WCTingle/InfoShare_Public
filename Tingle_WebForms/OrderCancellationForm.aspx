            ...
            <ContentTemplate>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="tdleft">
                            <telerik:RadComboBox runat="server" ID="ddlPOStatus" DataTextField="StatusCode" DataValueField="RecordId" Width="150px"
                    ...
                    <tr>
                        ...
                        <td class="tdleft">
                            <input type="text" id="txtDateRequired" runat="server" autopostback="false" /></td>
