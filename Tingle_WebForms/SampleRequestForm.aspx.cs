    ...
    public partial class SampleRequestForm : System.Web.UI.Page
    {
        ...
        public void FillEmailAddressLabels()
        {
            ...
            if (cbNotifyStandard.Checked)
            {
                ...
                {
                    if (ctx.EmailAddresses.Any(x => x.Status == 1 && x.TForm.FormName == "Sample Request" && x.Company == ddlCompany.SelectedText))
                    {
                        ICollection<EmailAddress> emailAddresses = ctx.EmailAddresses.Where(x => x.Status == 1 && x.TForm.FormName == "Sample Request" && x.Company == ddlCompany.SelectedText).ToList();
                    ...
                    using (FormContext ctx = new FormContext())
                    {
                        ...
                        if (lblEmailsSentTo.Text != "")
                        {
                            ...
                            bodyHtml.AppendLine("<div style=\"width:50%; text-align:center;\"><img src=\"http://www.wctingle.com/img/Logo.jpg\" /><br /><br />")
                                .Append("A new Sample Request Request has been submitted.<br /><br />")
                                .AppendLine("<table style=\"border: 4px solid #d0604c;background-color:#FFF;width:100%;margin-lefT:auto; margin-right:auto;\">")
                                .AppendLine("    <tr>")
                                .AppendLine("        <td colspan=\"4\" style=\"text-align: center;vertical-align: middle;font-weight: bold;font-size: 20px;border: 4px solid #d0604c; color:#FFF; background-color:#bc4445;\">Sample Request</td>")
                                .AppendLine("    </tr>")
                                .AppendLine("    <tr>")
                            ...
                            {
                                bodyHtml.AppendLine("<div style=\"width:80%; color: white; margin: 0 auto; text-align:center;\">Comments<br /></div>")
                            ...
                            bool result = msg.SendMail("InfoShare@wctingle.com", emailList, "Sample Request", bodyHtml.ToString(), submittedForm, formId, currentUser);
