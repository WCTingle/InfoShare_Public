<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CannotWaitForContainerForm.aspx.cs" Inherits="Tingle_WebForms.CannotWaitForContainerForm" %>
                    ...
                    <tr class="trheader">
                        <td colspan="4" class="tdheader">
                            ...
                            <div style="float: left; width: 50%">
                                Cannot Wait For Container Request
                            </div>
                            <div style="float: left; width: 25%">&nbsp;
                            </div>
                        </td>
