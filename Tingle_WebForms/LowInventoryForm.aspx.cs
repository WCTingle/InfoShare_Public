...
{
    public partial class LowInventoryForm : System.Web.UI.Page
    {
                ...
                if (Page.IsValid)
                {
                    ...
                    using (FormContext ctx = new FormContext())
                    {
                        ...
                        if (lblEmailsSentTo.Text != "")
                        {
                            ...
                            bool result = msg.SendMail("InfoShare@wctingle.com", emailList, "Low Inventory Request", bodyHtml.ToString(), submittedForm, formId, currentUser);
