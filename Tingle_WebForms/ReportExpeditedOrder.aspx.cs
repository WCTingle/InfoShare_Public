...
{
    public partial class ReportExpeditedOrder : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (newLogic.HasAccess(currentUser, "Expedited Order"))
            {
        ...
        public Tingle_WebForms.Models.ExpeditedOrderForm GetFormDetails([Control("gvReport")] int? RecordId, [QueryString("formId")] Nullable<Int32> formId)
        {
            ...
            if (RecordId == null)
            {
                if (formId != null)
                {
                    myForm = ctx.ExpeditedOrderForms.FirstOrDefault(f => f.RecordId == formId);
                }
            }
            else
            {
                myForm = ctx.ExpeditedOrderForms.FirstOrDefault(f => f.RecordId == RecordId);
            }
        ...
        public IEnumerable<NotifyOtherList> GetOtherEmails()
        {
            try
            {
                using (FormContext ctx = new FormContext())
                {
                    IEnumerable<NotifyOtherList> userList = from s in ctx.SystemUsers
                                                            select new NotifyOtherList { Address = s.EmailAddress, Name = s.DisplayName };

                    IEnumerable<NotifyOtherList> otherList = from n in ctx.NotificationEmailAddresses
        ...
        public IQueryable<SkuQuantity> GetSkuQuantities()
        {
            ...
            if (ctx.SkuQuantityItems.Any(x => x.ExpeditedOrderForm.RecordId == id))
            {
                IQueryable<SkuQuantity> skuList = ctx.SkuQuantityItems.Where(x => x.ExpeditedOrderForm.RecordId == id).OrderBy(x => x.RecordId);
        ...
        public void FillEmailAddressLabels()
        {
            ...
            if (cbNotifyStandard.Checked)
            {
                using (FormContext ctx = new FormContext())
                {
                    if (ctx.EmailAddresses.Any(x => x.Status == 1 && x.TForm.FormName == "Expedited Order" && x.Company == ddlCompanyEdit.SelectedText))
                    {
                        ICollection<EmailAddress> emailAddresses = ctx.EmailAddresses.Where(x => x.Status == 1 && x.TForm.FormName == "Expedited Order" && x.Company == ddlCompanyEdit.SelectedText).ToList();
            ...
            )
        {
            ...
            IQueryable<Tingle_WebForms.Models.ExpeditedOrderForm> ExpeditedOrderFormList = ctx.ExpeditedOrderForms.OrderByDescending(forms => forms.Timestamp);

            if (GlobalStatus != null)
            {
                if (GlobalStatus == "Active")
                {
                    ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.Status.StatusText != "Completed");
                }
            ...
            {
                var reqHistory = ctx.UserRequests.Where(x => x.User.SystemUserID == currentUser.SystemUserID && x.Form.FormName == "Expedited Order");
                var assHistory = ctx.UserAssignments.Where(x => x.User.SystemUserID == currentUser.SystemUserID && x.Form.FormName == "Expedited Order");

                ExpeditedOrderFormList = ExpeditedOrderFormList
            ...
            if (formId != null)
            {
                ...
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.RecordId.Equals(id));
            }
            ...
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.Company == Company);
            }
            ...
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.SkuQuantityItems.Any(x => x.MaterialSku.Contains(MaterialSku)));
            }
            if (ExpediteCodeId != null)
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.ExpediteCode.ExpediteCodeID == ExpediteCodeId);
            }
            ...
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.SkuQuantityItems.Any(x => x.Quantity.Contains(QuantityOrdered)));
            }
            ...
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.ShipToPhone.Contains(ShipToPhone.Trim()));
            }
            if (StatusId != null)
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.Status.StatusId == StatusId);
            }
            if (!String.IsNullOrWhiteSpace(DueByFrom))
            {
                DateTime.TryParse(DueByFrom, out dtDueByFrom);
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.DueDate >= dtDueByFrom);
            }
            if (!String.IsNullOrWhiteSpace(DueByTo))
            {
                DateTime.TryParse(DueByTo, out dtDueByTo);
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.DueDate <= dtDueByTo);
            }
            if (RequestedById != null)
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.RequestedUser.SystemUserID == RequestedById);
            }
            if (AssignedToId != null)
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.AssignedUser.SystemUserID == AssignedToId);
            }
            if (PriorityId != null)
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.Priority.RecordId == PriorityId);
            }
            ...
            if (Session["MyForms"] != null)
            {
                ...
                {
                    ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.RequestedUser.SystemUserID == currentUser.SystemUserID);
                }
                else if (Session["MyForms"].ToString() == "Assigned")
                {
                    ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.AssignedUser.SystemUserID == currentUser.SystemUserID);
                }
                else if (Session["MyForms"].ToString() == "Created")
                {
                    ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.SubmittedUser.SystemUserID == currentUser.SystemUserID);
                }
            }
        ...
        protected void fvReport_ItemUpdating(object sender, FormViewUpdateEventArgs e)
        {
            if (IsValid)
            {
                ...
                Tingle_WebForms.Models.ExpeditedOrderForm myForm = ctx.ExpeditedOrderForms.FirstOrDefault(eof => eof.RecordId == id);
                ...
                try
                {
                    ...
                    if (myForm.AssignedUser != null && !newLogic.HasBeenAssigned(myForm.AssignedUser, myForm.RecordId, "Expedited Order"))
                    {
                    ...
                    if (myForm.RequestedUser != null && !newLogic.HasBeenRequested(myForm.RequestedUser, myForm.RecordId, "Expedited Order"))
                    {
        ...
        {
            Tingle_WebForms.Models.ExpeditedOrderForm myForm = ctx.ExpeditedOrderForms.FirstOrDefault(eof => eof.RecordId == FormId);
            ...
            {
                if (ctx.Comments.Any(x => x.Form.FormName == "Expedited Order" && x.RelatedFormId == myForm.RecordId))
                {
                    anyComments = true;

                    IEnumerable<Comments> commentsList = ctx.Comments
                        .Where(x => x.Form.FormName == "Expedited Order" && x.RelatedFormId == myForm.RecordId)
                        .Include(x => x.User)
            ...
            {
                if (ctx.Comments.Any(x => x.Form.FormName == "Expedited Order" && x.RelatedFormId == myForm.RecordId && x.SystemComment == false))
                {
                    anyComments = true;

                    IEnumerable<Comments> commentsList = ctx.Comments
                        .Where(x => x.Form.FormName == "Expedited Order" && x.RelatedFormId == myForm.RecordId && x.SystemComment == false)
                        .Include(x => x.User)
                        .OrderByDescending(x => x.RecordId)
                        .ToList();
            ...
            bodyHtml.AppendLine("<div style=\"width:50%; text-align:center;\"><img src=\"http://www.wctingle.com/img/Logo.jpg\" /><br /><br />")
                ...
                .AppendLine("    <tr>")
                .AppendLine("        <td colspan=\"4\" style=\"text-align: center;vertical-align: middle;font-weight: bold;font-size: 20px;border: 4px solid #d0604c; color:#FFF; background-color:#bc4445;\">Expedited Order Request Update</td>")
                .AppendLine("    </tr>")
                .AppendLine("    <tr>")
            ...
            if (ctx.SkuQuantityItems.Any(x => x.ExpeditedOrderForm.RecordId == myForm.RecordId))
            {
                bodyHtml.AppendLine("<tr><td colspan=\"4\"><table>");

                var skus = ctx.SkuQuantityItems.Where(x => x.ExpeditedOrderForm.RecordId == myForm.RecordId);
            ...
            bool result = msg.SendMail("InfoShare@wctingle.com", emailList, "Expedited Order Request Update", bodyHtml.ToString(), submittedForm, myForm.RecordId, currentUser);
        }
        ...
        protected void fvReport_PreRender(object sender, EventArgs e)
        {
            ...
            {
                var expeditedOrderForm = ctx.ExpeditedOrderForms.FirstOrDefault(eof => eof.RecordId == recordId);

                isComplete = expeditedOrderForm.Status.StatusText == "Completed" ? true : false;
            }
        ...
        protected void ddlCompanyEdit_DataBinding(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var ctx = new FormContext())
                {
                    var thisForm = ctx.ExpeditedOrderForms.FirstOrDefault(eof => eof.RecordId == recordId);
            ...
            try
            {
                ...
                using (var ctx = new FormContext())
                {
                    ...
                    Comments newComment = new Comments
                    {
                        ...
                        RelatedFormId = expeditedOrderForm.RecordId,
                        SystemComment = false,
                        Timestamp = DateTime.Now,
        ...
        public IEnumerable<Comments> rptrComments_GetData()
        {
            try
            {
                ...
                using (FormContext ctx = new FormContext())
                {
                    if (ctx.Comments.Any(x => x.Form.FormName == "Expedited Order" && x.RelatedFormId == recordId))
                    {
                        IEnumerable<Comments> commentsList = ctx.Comments
                            .Where(x => x.Form.FormName == "Expedited Order" && x.RelatedFormId == recordId)
                            .Include(x => x.User)
                            .OrderByDescending(x => x.RecordId)
                            .ToList();
        ...
        protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    using (FormContext ctx = new FormContext())
                    {
                        var thisForm = ctx.ExpeditedOrderForms.FirstOrDefault(x => x.RecordId == recordId);
                        ...
                        if (ctx.SkuQuantityItems.Any(x => x.ExpeditedOrderForm.RecordId == recordId))
                        {
                            var skuQs = ctx.SkuQuantityItems.Where(x => x.ExpeditedOrderForm.RecordId == recordId);
