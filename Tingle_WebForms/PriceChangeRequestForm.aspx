            ...
            <ContentTemplate>
                ...
                <table>
                    <tr class="trheader">
                        <td colspan="4" class="tdheader">
                            <div style="float: left; width: 25%">
                                <telerik:RadDropDownList runat="server" ID="ddlCompany" AutoPostBack="true" CausesValidation="false" OnSelectedIndexChanged="ddlCompany_SelectedIndexChanged" Width="75px" Skin="Default">
                                    <Items>
                    ...
                    <tr>
                        ...
                        <td class="tdleft">
                            <asp:TextBox ID="txtLineNumber" runat="server" MaxLength="100"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdright">
                        ...
                        <td class="tdleft">
                            <telerik:RadDropDownList runat="server" ID="ddlProduct" AutoPostBack="false" CausesValidation="false" Width="100px" Skin="Default" SelectMethod="GetProducts"
                                DataTextField="ProductText" DataValueField="RecordId">
                            </telerik:RadDropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="tdleft">
                            <asp:TextBox ID="txtSalesRep" runat="server" MaxLength="100"></asp:TextBox></td>
                        <td class="tdright">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="SKU field is required." ForeColor="Red" Font-Size="12px"
                                ControlToValidate="txtSKU" SetFocusOnError="true" Display="None"></asp:RequiredFieldValidator>Material SKU:</td>
                        <td class="tdleft">
                            <asp:TextBox ID="txtSKU" runat="server" MaxLength="100"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="tdright">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Order # field is required." ForeColor="Red" Font-Size="12px"
                                ControlToValidate="txtOrderNumber" SetFocusOnError="true" Display="None"></asp:RequiredFieldValidator>Reference / Order #:</td>
                        <td class="tdleft">
                            <asp:TextBox ID="txtOrderNumber" runat="server" MaxLength="100"></asp:TextBox></td>
                        <td class="tdright">
                        ...
                        <td class="tdleft">
                            <asp:TextBox ID="txtQuantity" runat="server" MaxLength="100"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="tdright">
                        ...
                        <td class="tdleft">
                            <asp:TextBox ID="txtCrossRefOldOrderNumber" runat="server" MaxLength="100"></asp:TextBox></td>
                        <td class="tdright">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Price field is required." ForeColor="Red" Font-Size="12px"
                                ControlToValidate="txtPrice" SetFocusOnError="true" Display="None"></asp:RequiredFieldValidator>Price:</td>
                        <td class="tdleft">
                            <asp:TextBox ID="txtPrice" runat="server" MaxLength="100"></asp:TextBox></td>
                    </tr>
                    <tr>
                                ...
                                <table style="border: none;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 18%; text-align: left">
                                            <input type="text" id="txtDueByDate" runat="server" style="width: 75px;" /></td>
                                        ...
                                        <td style="width: 10%; text-align: left">
                                            <telerik:RadDropDownList ID="ddlStatus" runat="server" SelectMethod="GetStatuses"
                                                DataTextField="StatusText" DataValueField="StatusID" Skin="Default" Width="100px">
                                            </telerik:RadDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <br />
                            <span class="formRedText">Comments</span><br />
