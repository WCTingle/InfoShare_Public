<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CannotWaitForContainerDetails.ascx.cs" Inherits="Tingle_WebForms.CannotWaitForContainerDetails" %>

<asp:HiddenField runat="server" ID="hRecordId" Value='<%# Eval("RecordId") %>' />
<asp:Label ID="lblMessage" runat="server" Text=""></asp:Label>
<table>
    <tr class="trheader">
        <td colspan="4" class="tdheader">Cannot Wait For Container Request ID:
    ...
    <tr>
        ...
        <td class="tdright" style="width: 15%">Plant:</td>
        <td class="tdleft" style="width: 35%">
    ...
    <tr>
        ...
        <td class="tdleft" style="width: 35%">
            <telerik:RadTextBox ID="txtLineEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Line") %>' CssClass="report-textbox-normal"></telerik:RadTextBox><br />
        </td>
        <td class="tdright" style="width: 15%">
        ...
        <td class="tdleft" style="width: 35%">
            <telerik:RadTextBox ID="txtQuantityEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Quantity") %>' CssClass="report-textbox-normal"></telerik:RadTextBox><br />
        </td>
    </tr>
    <tr>
        <td class="tdright" style="width: 15%">
        ...
        <td class="tdleft" style="width: 35%">
            <telerik:RadTextBox ID="txtSKUEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SKU") %>' CssClass="report-textbox-normal"></telerik:RadTextBox><br />
        </td>
        <td class="tdright" style="width: 15%"></td>
        <td class="tdleft" style="width: 35%"></td>
    </tr>
