<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportExpeditedOrder.aspx.cs" Inherits="Tingle_WebForms.ReportExpeditedOrder" EnableEventValidation="true" %>
        ...
        <ContentTemplate>
            <div class="divcenter">
                ...
                <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                    ...
                    <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.ExpeditedOrderForm" SelectMethod="GetFormDetails" OnDataBinding="fvReport_DataBinding"
                        ...
                        <EditItemTemplate>
                            <asp:PlaceHolder runat="server" ID="phFVDetails">
                                ...
                                <table>
                                    <tr class="trheader">
                                        <td colspan="4" class="tdheader">Expedited Order Request Details</td>
                                    </tr>
                                    <tr>
