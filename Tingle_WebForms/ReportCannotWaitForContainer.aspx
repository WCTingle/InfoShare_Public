<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportCannotWaitForContainer.aspx.cs" Inherits="Tingle_WebForms.ReportCannotWaitForContainer" %>
        ...
        <img src="Images/loading.gif" style="position:absolute; top:40%;" />
            ...
            <div class="divcenter">
                <asp:Panel ID="pnlFilter" runat="server">
                    <table>
                        <tr class="trheader">
                            <td colspan="4" class="tdheader">
                                ...
                                <div style="float: left; width: 50%">
                                    Cannot Wait For Container Requests
                                </div>
                                <div style="float: left; width: 25%">
                        ...
                        <tr>
                            ...
                            <td class="tdleft">
                                <telerik:RadDropDownList ID="ddlPlants" runat="server" SelectMethod="GetPlants" Skin="Default" Width="150px" AutoPostBack="true"
                                    CausesValidation="false" DataTextField="PlantText" DataValueField="RecordId" DefaultMessage="Any Plant">
                                </telerik:RadDropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <telerik:RadGrid runat="server" ID="gvReport" AllowSorting="True" AllowPaging="True" GridLines="Both"
                                        ...
                                        <MasterTableView SelectMethod="GetReportData" AllowFilteringByColumn="false" AllowSorting="true" ItemType="Tingle_WebForms.Models.CannotWaitForContainerForm"
	                                        ...
	                                        <EditFormSettings UserControlName="CannotWaitForContainerDetails.ascx" EditFormType="WebUserControl">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn DataField="OrderNumber" DataType="System.String" Exportable="true" Groupable="False" SortExpression="OrderNumber"
			                                UniqueName="OrderNumber" HeaderText="Order #" AllowFiltering="false">
			                                <HeaderStyle HorizontalAlign="Center" Width="15%" />
			                                <ItemStyle HorizontalAlign="Center" />
			                                <ItemTemplate>
				                                <asp:Label ID="lblOrderNumber" runat="server" Text='<%# Eval("OrderNumber") %>'></asp:Label>
                                                <telerik:RadToolTip runat="server" ID="ttOrderNumber" Position="TopRight" RelativeTo="Element" TargetControlID="lblOrderNumber" ShowEvent="OnMouseOver"
                                        ...
                                        <telerik:GridTemplateColumn DataField="Plant" DataType="System.String" Exportable="true" Groupable="False" SortExpression="Plant"
			                                UniqueName="Plant" HeaderText="Plant" AllowFiltering="false">
			                                <HeaderStyle HorizontalAlign="Center" Width="15%" />
			                                <ItemStyle HorizontalAlign="Center" />
			                                <ItemTemplate>
				                                <asp:Label ID="lblPlant" runat="server" Text='<%# Eval("Plant.PlantText") %>'></asp:Label>
			                                </ItemTemplate>
		                                </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn DataField="Line" DataType="System.String" Exportable="true" Groupable="False" SortExpression="Line"
			                                UniqueName="Line" HeaderText="Line" AllowFiltering="false">
                ...
                <%--<asp:Panel ID="pnlDetails" runat="server" Visible="false">
                    ...
                    <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.CannotWaitForContainerForm" SelectMethod="GetFormDetails" OnDataBinding="fvReport_DataBinding"
                        ...
                        <EditItemTemplate>
                            <asp:PlaceHolder runat="server" ID="phFVDetails">
                                ...
                                <table>
                                    <tr class="trheader">
                                        <td colspan="4" class="tdheader">Cannot Wait For Container Request Details</td>
                                    </tr>
                                    <tr>
                                ...
                                <asp:Label ID="lblRecordId" runat="server" Text='<%#: Eval("RecordId") %>'></asp:Label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdright">Plant:</td>
                                        <td class="tdleft">
                                            <telerik:RadDropDownList ID="ddlPlantsEdit" runat="server" SelectMethod="GetPlants" Skin="Default" Width="150px" AutoPostBack="true"
                                                CausesValidation="false" DataTextField="PlantText" DataValueField="RecordId" OnDataBound="ddlPlantsEdit_DataBound">
                                            </telerik:RadDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
